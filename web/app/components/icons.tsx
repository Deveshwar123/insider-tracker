// Inline SVG icons (Lucide geometry) — replaces emoji used as UI icons, so
// they scale cleanly, inherit currentColor, and theme consistently.
type IconProps = { size?: number; className?: string };

function svg(children: React.ReactNode, size = 16, className?: string) {
  return (
    <svg
      width={size}
      height={size}
